/* UI language catalogs. Default is English; Settings can switch to Vietnamese. */
(function (global) {
  ...
  RB.I18N = {
    en: {
      ...
      'settings.openAtLoginHelp': 'Starts Rewrite Better in the system tray when you log in to Windows.',
      ...
      'settings.shortcutHelp': 'Click the shortcut, then press a new combo. Include Ctrl, Alt, or Win. Esc cancels.',
      ...
      'settings.disclaimer':
        'API keys are stored only on this computer (Windows Credential Manager). They are never uploaded or saved anywhere else. You are responsible for keeping them private.',
      ...
      'panel.result': 'Result',
      'panel.resultHint': 'Result will appear here. Ctrl+Enter to run. Ctrl+Alt+Enter to replace.',
      'panel.tone': 'Tone',
      ...
      'panel.pasteActivateFailed': '❌ Could not switch back to the original app. Result is on the clipboard — press Ctrl+V.',
      ...
      'paste.paste': 'Paste',
      'paste.replaceHelp': 'Replace the selection in %@. Ctrl+Alt+Enter',
      'paste.pasteHelp': 'Paste into %@ at the caret. Ctrl+Alt+Enter',
    ...
    vi: {
      ...
      'settings.openAtLoginHelp': 'Khởi động Rewrite Better trên khay hệ thống khi bạn đăng nhập Windows.',
      'settings.openAtLoginOn': '✅ Sẽ mở khi bạn đăng nhập',
      'settings.openAtLoginOff': '✅ Không mở khi đăng nhập',
      'settings.openAtLoginFail': '❌ Không bật được Open at login',
      'settings.shortcut': 'Phím tắt mở bảng',
      'settings.reset': 'Đặt lại',
      'settings.shortcutHelp': 'Bấm phím tắt, rồi nhấn tổ hợp mới. Cần có Ctrl, Alt hoặc Win. Esc để hủy.',
      ...
      'settings.disclaimer':
        'API key chỉ lưu trên máy này (Windows Credential Manager). Không được tải lên hay lưu ở nơi khác. Bạn chịu trách nhiệm giữ chúng bí mật.',
      ...
      'panel.resultHint': 'Kết quả hiện ở đây. Ctrl+Enter để chạy. Ctrl+Alt+Enter để thay thế.',
      'panel.tone': 'Giọng',
      ...
      'panel.pasteActivateFailed': '❌ Không chuyển lại được app gốc. Kết quả đang ở clipboard — nhấn Ctrl+V.',
      ...
      'provider.groq.summary': 'Fallback thứ hai. Groq nhanh và có gói miễn phí.',
      ...
      'error.allKeysResting': '❌ Tất cả API key đang nghỉ đến ngày mai. Thêm key mới hoặc thử lại sau.',
      'error.401': '❌ API Key không hợp lệ hoặc đã hết hạn.',
      'error.403': '❌ Không có quyền truy cập API.',
      'error.429': '❌ Đã vượt quá giới hạn requests trên mọi API key.',
      'error.402': '❌ Hết quota / cần thanh toán trên mọi API key.',
      ...
      'paste.paste': 'Dán',
      'paste.replaceHelp': 'Thay phần chọn trong %@. Ctrl+Alt+Enter',
      'paste.pasteHelp': 'Dán vào %@ tại con trỏ. Ctrl+Alt+Enter',
