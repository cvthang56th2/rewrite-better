...
enum L10n {
    ...
    private static let english: [String: String] = [
        ...
        "panel.result": "Result",
        "panel.resultHint": "Result will appear here. ⌘↩ to run. ⌥⌘↩ to replace in the original app.",
        "panel.copy": "📋 Copy",
        "panel.copied": "✅ Copied",
        "panel.tone": "Tone",
        ...
        "a11y.untrusted": "⚠️ macOS has not trusted this running copy (often because Accessibility still points at an old entry).",
        ...
        "api.missing": "⚠️ API key is not configured.",
        "api.configure": "Configure",
        "api.invalid": "⚠️ There is a problem with the API key.",
        "api.check": "Check",
        ...
        "settings.keysPartial": "⚠️ %@ OK · %@ failed",
        ...
        "error.missingKey": "❌ API key is not configured. Open Settings.",
        ...
        "panel.pasteNoTarget": "❌ No previous app to paste into. Result is on the clipboard.",
    ...
    private static let vietnamese: [String: String] = [
        ...
        "panel.resultHint": "Kết quả hiện ở đây. ⌘↩ để chạy. ⌥⌘↩ để thay trong app gốc.",
        "panel.copy": "📋 Sao chép",
        ...
        "a11y.untrusted": "⚠️ macOS chưa trust bản app đang chạy (thường do toggle đang gắn entry cũ).",
        ...
        "api.missing": "⚠️ Chưa cấu hình API Key.",
        "api.configure": "Cấu hình",
        "api.invalid": "⚠️ API Key có vấn đề.",
        "api.check": "Kiểm tra",
        ...
        "error.missingKey": "❌ Chưa cấu hình API Key. Vui lòng vào Cài đặt.",
        ...
        "panel.pasteNoTarget": "❌ Không có app trước để dán. Kết quả đang ở clipboard.",
