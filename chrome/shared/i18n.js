...
(function (global) {
  ...
  RB.I18N = {
    en: {
      ...
      'panel.result': 'Result',
      'panel.resultHint': 'Result will appear here. ⌘↩ / Ctrl+Enter to run.',
      'panel.copy': '📋 Copy',
      'panel.copied': '✅ Copied',
      'panel.tone': 'Tone',
      ...
      'panel.missingKey': '❌ API key is not configured. Open Settings.',
      ...
      'panel.apiMissing': '⚠️ API key is not configured. <a href="#" data-action="settings">Configure</a>',
    ...
    vi: {
      ...
      'panel.resultHint': 'Kết quả hiện ở đây. ⌘↩ / Ctrl+Enter để chạy.',
      'panel.copy': '📋 Sao chép',
      ...
      'panel.missingKey': '❌ Chưa cấu hình API Key. Vui lòng vào Cài đặt.',
      ...
      'panel.apiMissing': '⚠️ Chưa cấu hình API Key. <a href="#" data-action="settings">Cấu hình ngay</a>',
