const COPY = {
  en: {
    ...
    "p.s6": "This website",
    "p.s6b": "The download site is static files on Vercel. Language preference is stored in your browser (localStorage). We use Vercel Web Analytics for page views and download-button clicks. That data stays with Vercel; we do not use it for ads.",
    "p.s7": "Contact",
  ...
  vi: {
    ...
    "p.s6": "Website này",
    "p.s6b": "Trang tải về là file tĩnh trên Vercel. Ngôn ngữ giao diện lưu trong trình duyệt (localStorage). Chúng tôi dùng Vercel Web Analytics cho lượt xem trang và click nút tải. Dữ liệu nằm ở Vercel; không dùng để quảng cáo.",
    "p.s7": "Liên hệ",
